...
public class AppMain08 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 323, 547);
		...
		btnMsgDlg.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(
						...
						"Hello",  // 다이얼로그의 타이틀(제목)
						JOptionPane.INFORMATION_MESSAGE, // 메시지 타입 - 0,1...int로 기재가능
						null); // 아이콘
			}
		});
		btnMsgDlg.setFont(new Font("돋움", Font.PLAIN, 17));
		btnMsgDlg.setBounds(12, 10, 291, 45);
		...
		btnConfirmDlg.setFont(new Font("돋움", Font.PLAIN, 17));
		btnConfirmDlg.setBounds(12, 65, 291, 45);
		...
		btnOptionDlg.setFont(new Font("돋움", Font.PLAIN, 17));
		btnOptionDlg.setBounds(12, 120, 291, 45);
		...
		btnInputDlg.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//ShowInputDialof(parentComponent, message)				
//				String input = JOptionPane.showInputDialog(frame, "이름은?"); //frame 지울 시 모니터 중앙에 뜸
				
				// showInputDialog(parentCompnet, message, initialSelectionValue)
//				String input = JOptionPane.showInputDialog(frame, "나이는?", 0);//  initialSelectionValue 끝에 0 값을 미리 줌
				...
				System.out.println("input= " + input); // 취소 null리턴, 공백확인-> ""리턴
			}
		});
		btnInputDlg.setFont(new Font("돋움", Font.PLAIN, 17));
		btnInputDlg.setBounds(12, 175, 291, 45);
		...
		btnCustomDlg.setFont(new Font("돋움", Font.PLAIN, 17));
		btnCustomDlg.setBounds(12, 230, 291, 45);
		...
		btnCustomFrame.setFont(new Font("돋움", Font.PLAIN, 17));
		btnCustomFrame.setBounds(12, 285, 291, 45);
