...
// DAO(Data Access Object): Controller. 프로그램의 기능(비즈니스 로직담당 클래스)
public interface MemberDao {
	...
	/**
	 * 인덱스를 이용한 검색 기능: 검색할 인덱스를 전달 받아서, 배열에서 해당 인덱스의 Member 객체를 반환(리턴)하는 메서드.
	 * 
	 ...
	 * @param password - String. 업데이트할 비밀 번호.
