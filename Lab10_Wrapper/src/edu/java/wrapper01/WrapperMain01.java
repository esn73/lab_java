...
public class WrapperMain01 {
	...
	public static void main(String[] args) {
		...
		// 정수1을 담고 있는 Integer 객체를 생성. -> boxing
		...
		int  x = num1.intValue();
		// Intefer 객체(상자)가 담고 있는 기본 타입(int)의 값을 리턴. -> unboxing
		...
		Integer num3 = 100; // auto-boxing: 정수(int)을 클래스 객체로 변환해서 저장.
		int z = num3;//auto-unboxing: 클래스(Integer)객체에서 정수(int)값을 추출해서 기본타입(int)변수에 저장.
		System.out.println(z);

		//Integer.parseIng(String): 문자열(String)을 기본 타입 int 값으로 변환해서 리턴.
		...
		int value = Integer.parseInt(s); //입력받은 문자열을 정수(int) 기본타입으로 변환 **parseInt
