...
public class InheritanceMain06 {
	...
	public static void main(String[] args) {
		// Object 클래스의 메서드 override: toString(), hashCod(), equals(), ...
		
		Point pt1 = new Point();
		System.out.println(pt1.getClass()); //getClass ex) point의 설계도 edu.java...
		System.out.println(pt1.hashCode());
		System.out.println(pt1.toString()); //pt1를 문자열로 출력
		...
		//Object 클래스의  equals() 메서드는 원래 hashCode()값으로 같은지 다른지 비교
		// Point 클래스에서 override한 equals() 메서드는 멤버 변수(필드) x,y 값으로 같은 지 다른지를 비교함.
		...
		System.out.println(str1 == str2); // 문자열 내용 비교 -> false
		System.out.println(str1.equals(str2)); //->true
		// 기본(정수) 타입(boolean, int, double, ...)의 같음/다름 비교는 ==, != 연산자를 사용.
		// 참조(class) 타입(String, Object, ...)의 같음/다름 비교는 equals()메서드를 사용.
