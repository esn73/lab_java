...
public class inheritanceMain04 {
	...
	private static void printArray(Object[] array) { //**Object-string+integer 모두 저장가능
		System.out.print("[ ");
		for (Object s : array) {
			System.out.print(s + ", ");
		}
	...
	private static void printArray(String[] array) { // void 리턴하는 값이 없음 static main이랑 똑같이
		System.out.print("[ ");
		for (String s : array) {
			System.out.print(s + ", ");
		}
