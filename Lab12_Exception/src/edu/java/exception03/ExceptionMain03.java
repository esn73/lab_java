 ...
 * 		|__ Exception
 * 			|__RuntimeException
 * 				|__ArithmeticException, NullPointerException, ArrayIndexOutofBoundsException, ...
 * 
 * 
	...
	public static void main(String[] args) {
		...
		try {
			...
			array[0] = 1;
 			...
 			// Excetption 클래스와 Exception 클래스를 상속받는 모든 예외들을 처리할 수 있음.
 			System.out.println("배열에 원소를 저장할 수 없음.");
 		} 
		
//	catch(ArrayIndexOutOfBoundsException e){ // super 타입의 예외를 먼저 catch했기 때문에, 아래쪽 catch 블록은 절대 실행될 수 없다.
// 			
// 		}
